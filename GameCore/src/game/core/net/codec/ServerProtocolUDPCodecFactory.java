 ...
 * @version 1.0.0
 */
public class ServerProtocolUDPCodecFactory implements ProtocolCodecFactory
{
    ...
    public ServerProtocolUDPCodecFactory()
    {
        this(null, null, null);
    }
     ...
     */
    public ServerProtocolUDPCodecFactory(Integer sendMaxSize, Integer receivedMaxSize, Integer receivedMaxCount)
    {
        if (sendMaxSize != null)
        {
    ...
    {
        return new ServerProtocolUDPDecoder(receivedMaxSize, receivedMaxCount);
    }
    ...
    {
        return new ServerProtocolUDPEncoder(sendMaxSize);
    }
