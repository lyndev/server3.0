...
public class q_special_entityBean
{
    ...
    private int q_hero_Lv; // 特殊实体初始等级
    private int q_live_time; // 特殊实体持续时间(mS)
    ...
    private int q_default_activity; // 默认行为
    private int q_blood_type; // 血条类型
    private int q_can_beat; // 是否能被攻击
     ...
     * @return
     */
    public int getQ_entity_type()
    {
        return q_entity_type;
    }

    /**
     * set 特殊实体类型
     */
    public void setQ_entity_type(int q_entity_type)
    {
        this.q_entity_type = q_entity_type;
    }
     ...
     * @return
     */
    public int getQ_default_activity()
    {
        return q_default_activity;
    }

    /**
     * set 默认行为
     */
    public void setQ_default_activity(int q_default_activity)
    {
        this.q_default_activity = q_default_activity;
    }
     ...
     * set 是否能被攻击
     */
    public void setQ_can_beat(int q_can_beat)
    {
        this.q_can_beat = q_can_beat;
    }
}
